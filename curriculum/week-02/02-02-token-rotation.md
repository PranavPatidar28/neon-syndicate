# 02-02 — Token Rotation

**Week 2: Identity Protocol** · **CORE** · **100 XP**

## Transmission

The city needs you to **implement registration, login, access, and rotated hashed refresh sessions**. Completion requires behavior, evidence, and explanation to agree.
