# 02-03 — The Immortal Session

**Week 2: Identity Protocol** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **trace replay and revocation across restart and concurrent refresh**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply relational identity, secure authentication, and session lifecycle.
...
Review relational constraints, hashing, cookies, JWT purpose, and CSRF basics. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
