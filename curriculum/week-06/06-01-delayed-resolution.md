# 06-01 — Delayed Resolution

**Week 6: Ghost Workers** · **CORE** · **100 XP**

## Transmission

The city needs you to **schedule delayed resolution using identifiers and authoritative re-reads**. Completion requires behavior, evidence, and explanation to agree.
