# 06-03 — The Zombie Job

**Week 6: Ghost Workers** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **diagnose a stale or repeatedly delivered job without deleting evidence**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply queues, delayed jobs, retries, recovery, and schedules.
...
Review at-least-once delivery, backoff, dead letters, and reconciliation. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
