# 10-03 — The Invisible Admin

**Week 10: Overseer Console** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **find a privileged path absent from audit or policy enforcement**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply administration, auditability, moderation, and defensive controls.
...
Review threat modeling, least privilege, audit integrity, and rate limiting. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
