# 09-03 — The Phantom Optimism

**Week 9: Social Grid** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **roll back optimistic UI after conflict or authorization failure**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply durable notifications, feeds, search, caching, and optimistic UX.
...
Review cursor pagination, indexes, cache invalidation, and optimistic updates. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
