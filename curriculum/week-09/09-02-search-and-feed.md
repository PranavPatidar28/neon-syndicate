# 09-02 — Search and Feed

**Week 9: Social Grid** · **CORE** · **100 XP**

## Transmission

The city needs you to **build cursor feeds and search with indexes, cache policy, and accessible states**. Completion requires behavior, evidence, and explanation to agree.
