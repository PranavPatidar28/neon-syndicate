# 09-01 — Notification Pipeline

**Week 9: Social Grid** · **CORE** · **100 XP**

## Transmission

The city needs you to **create durable notifications with read state and delivery semantics**. Completion requires behavior, evidence, and explanation to agree.
