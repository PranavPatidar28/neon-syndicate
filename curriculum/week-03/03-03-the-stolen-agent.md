# 03-03 — The Stolen Agent

**Week 3: Agent Foundry** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **find an ownership or IDOR flaw using adversarial tests**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply owned resources, forms, generated clients, and authorization.
...
Review REST resource design, React forms, and ownership authorization. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
