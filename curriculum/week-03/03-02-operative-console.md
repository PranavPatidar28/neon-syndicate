# 03-02 — Operative Console

**Week 3: Agent Foundry** · **CORE** · **100 XP**

## Transmission

The city needs you to **build accessible forms and a generated typed API client**. Completion requires behavior, evidence, and explanation to agree.
