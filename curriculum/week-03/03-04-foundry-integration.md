# 03-04 — Foundry Integration

**Week 3: Agent Foundry** · **BOSS** · **200 XP**

## Transmission

The city needs you to **deliver CRUD, validation, state UX, and policy evidence**. Completion requires behavior, evidence, and explanation to agree.
