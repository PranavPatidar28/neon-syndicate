...
The city needs you to **model agent ownership and lifecycle without leaking persistence concerns**. Completion requires behavior, evidence, and explanation to agree.
