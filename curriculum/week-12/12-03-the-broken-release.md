# 12-03 — The Broken Release

**Week 12: Launch Night** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **triage a deliberately failed deployment and choose rollback or roll-forward**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply production delivery, recovery, demo quality, and architecture defense.
...
Review CI/CD, expand-contract migrations, secrets, backups, and incident response. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
