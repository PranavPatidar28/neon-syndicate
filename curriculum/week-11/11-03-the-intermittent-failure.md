# 11-03 — The Intermittent Failure

**Week 11: Red-Team Week** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **isolate a flaky cross-process failure with deterministic evidence**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply cross-layer verification, performance, observability, and failure drills.
...
Review test strategy, load models, query plans, and structured telemetry. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
