...
The city needs you to **fill a risk-based unit, integration, API, worker, socket, and E2E matrix**. Completion requires behavior, evidence, and explanation to agree.
