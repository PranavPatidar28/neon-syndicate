...
The city needs you to **compose global, syndicate, and ownership policies in explicit guards**. Completion requires behavior, evidence, and explanation to agree.
