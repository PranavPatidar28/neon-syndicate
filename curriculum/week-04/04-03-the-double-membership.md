# 04-03 — The Double Membership

**Week 4: Syndicate Wars** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **reproduce and eliminate concurrent duplicate membership**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply group lifecycle, invitations, roles, and concurrency.
...
Review many-to-many modeling, state transitions, RBAC, and race conditions. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
