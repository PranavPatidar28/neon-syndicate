# 05-02 — Transactional Launch

**Week 5: Mission Control** · **CORE** · **100 XP**

## Transmission

The city needs you to **start missions transactionally with assignments and idempotency keys**. Completion requires behavior, evidence, and explanation to agree.
