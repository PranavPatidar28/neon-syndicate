# 05-03 — The Double Reward

**Week 5: Mission Control** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **prove duplicate HTTP or job delivery cannot issue duplicate rewards**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply state machines, transactions, assignments, and idempotency.
...
Review finite-state machines, transactions, isolation, and idempotency. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
