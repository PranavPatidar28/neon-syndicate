# 01-04 — Foundation Online

**Week 1: Boot Sequence** · **BOSS** · **200 XP**

## Transmission

The city needs you to **integrate repeatable setup, ADR reasoning, and fresh-clone evidence**. Completion requires behavior, evidence, and explanation to agree.
...
- Integrate the week into a demonstrable vertical slice without introducing next-week features.
...
Manual gate: Demonstrate the weekly journey, an adversarial journey, and a dependency-failure/recovery journey.
