# 01-02 — Service Lifelines

**Week 1: Boot Sequence** · **CORE** · **100 XP**

## Transmission

The city needs you to **add readiness checks that distinguish process health from dependency health**. Completion requires behavior, evidence, and explanation to agree.
