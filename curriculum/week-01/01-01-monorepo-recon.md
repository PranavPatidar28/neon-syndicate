# 01-01 — Monorepo Recon

**Week 1: Boot Sequence** · **CORE** · **100 XP**

## Transmission

The city needs you to **map workspace dependencies and prove each process boundary**. Completion requires behavior, evidence, and explanation to agree.
