# 01-03 — The Vanishing Environment

**Week 1: Boot Sequence** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **diagnose configuration precedence and startup validation**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply tooling, runtime boundaries, local infrastructure, and engineering decisions.
...
Review TypeScript workspaces, processes, environment variables, and HTTP health semantics. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.

## Required behavior

- Diagnose a seeded or learner-created defect from symptoms, tests, logs, and authoritative state before changing code.
...
Manual gate: Capture reproduction, competing hypotheses, discriminating experiment, root cause, fix, and regression proof.
