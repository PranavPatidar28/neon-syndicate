# 07-03 — The Leaking Room

**Week 7: City Pulse** · **DEBUG** · **75 XP**

## Transmission

The city needs you to **demonstrate and fix cross-syndicate room leakage**. Completion requires behavior, evidence, and explanation to agree.

## Learning objectives

- Apply authenticated sockets, rooms, live events, and recovery.
...
Review WebSocket lifecycle, rooms, authentication, ordering, and cursors. Read the architecture, domain, security, testing, and relevant ADR documents. Journal your predicted data flow before coding.
